            ...
            <div class="audio-top-songname">
              <div class="audio-song-info">
                ...
                <div class="song-artis" @click="gosingerdetail">
                  <div class="ar-box">
                    <div class="fl ar-name">{{ songdetaildata.singername }}</div>
                    <div class="fl go-artis">
            ...
            <div class="song-img-animation">
              <div class="cd-wapper">
                <div class="cd-play" :class="hasplay ? 'running' : 'paused'">
                  <img class="autoimg" :src="audioimg" />
                </div>
              </div>
            </div>
            <!-- 小歌词高亮 -->
...
export default {
  ...
  methods: {
    ...
    lyricscroll(text) {
      ...
      for (let i = 0; i < row; i++) {
        let temp_row = arr[i]; //现在每一行格式大概就是这样"[00:04.302][02:10.00]";
